---
title: "La science ouverte et l'open data dans la recherche"
subtitle: "Pourquoi, comment, pour quels usages ?"
...
---
class: center
# .red[La science ouverte et l'open data dans la recherche]
## Pourquoi, comment, pour quels usages ?
### Antoine Blanchard, Datactivist
18 décembre 2020

![:abs 60%, 20%, 70%](img/LOGO_FEDER_odeon-Fr.jpg)
...
---
### Les chercheurs partageaient-ils des données avant les administrations ?

--

.center[.reduite2[![](img/Journal_des_sçavans_janvier_1665.jpg)]]

.footnote[Source : Sieur de Hédouville (pseudonyme de Denis de Sallo), "De la comète", *Journal des sçavans*, 5 Janvier 1665]
...
.footnote[*Principes et lignes directrices pour l’accès aux données de la recherche financée sur fonds publics* (2007)]

---
## Quelques jalons historiques
- 1933 : Ragnar Frisch, 1er numéro de la revue *Econometrica* : "in *Econometrica* the original raw data will, as a rule, be published, unless their volume is excessive. This is important in order to stimulate criticism, control, and further studies"
...
- mars 2020 : publication de l'article "Epidemiological data from the COVID-19 outbreak, real-time case information" dans la revue _Scientific Data_ ([lien](https://www.nature.com/articles/s41597-020-0448-0))
...
- responsabilité déontologique du chercheur (National Research Council (2003), *Sharing Publication-Related Data and Materials: Responsibilities of Authorship in the Life Sciences*)
...
- traitent certains climatologistes "sceptiques" avec irrespect
...
### À qui appartiennent les données de la recherche ?
...
### À qui appartiennent les données expérimentales, d'observation, de simulation… en tableau de la recherche ?
...
### En 2016, la Loi pour une république numérique crée-t-elle ?
...
La LRN prévoit la diffusion d'un écrit par son **auteur**, et l'ouverture par défaut des données administratives.
...
Le PNSO rappelle le cadre légal.
---
class:center,inverse, middle
...
.footnote[Victoria Stodden (2010), "[The Digitization of Science and the Degradation of the Scientific Method](https://www.ischool.berkeley.edu/sites/default/files/VictoriaStoddenBIS2010.pdf)", UC Berkeley School of Information Dean's Lecture]
...
.reduite3.center[![](img/FAIR_data_principles.jpg)]

.footnote[CC BY-SA SangyaPundir]
...
.reduite3.center[![](img/Cell_Biology_Education.png)]
...
### Jean-Christophe Desconnets, directeur de la Mission science ouverte à l’IRD
