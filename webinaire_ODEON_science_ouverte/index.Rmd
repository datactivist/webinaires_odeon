...
show <- FALSE #FALSE pour la version courte, TRUE pour la version longue (avec les facettes de l'open data et le climategate)
```
...
count: false
class: center
# .red[Webinaire sur la science ouverte et l'open data dans la recherche]
<br />
## Datactivist + Avitem
<br />
18 décembre 2020
...
# Programme du .red[webinaire]

### Présentation du projet ODEON

### Introduction
#### Antoine Blanchard (Datactivist) : "La science ouverte et l'open data dans la recherche : pourquoi, comment, pour quels usages ?"

### Table-ronde
####Témoignages sur l’ouverture des données dans les sciences de l’environnement (océanographie et agronomie) et dans un institut de recherche tourné vers les pays méditerranéens et les pays du Sud
...
Si vous avez suivi les précédents webinaires de cette série, il a souvent été question des données administratives. Nous allons parler ici des données de la recherche.
